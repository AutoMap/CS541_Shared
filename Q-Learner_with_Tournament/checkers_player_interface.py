...
This is the KEY INTERFACE that we must implement!
"""
...
class ExampleNeuralNetworkPlayerTemplate(AbstractTrainableCheckersPlayer):
    ...
    def __init__(self, player_configuration: CheckersPlayerConfiguration):
        ...
        self.neural_network_model = None  # TODO: Initialize neural network
        self.training_optimizer = None    # TODO: Initialize optimizer
        self.loss_function = None         # TODO: Initialize loss function
    ...
    def choose_move_from_legal_actions(self, current_board_state: np.ndarray, 
                                     available_legal_actions: List[int]) -> int:
        """
        IMPLEMENT THIS: Use a neural network to choose the best move
        
        Example approach:
        1. Pass current_board_state through a neural network
    ...
    def update_from_game_experience(self, game_state_sequence: List[np.ndarray],
                                  ...
                                  reward_sequence: List[float]) -> None:
        """
        IMPLEMENT THIS: Train a neural network using game experience
        
        Example approach:
        1. Create training data from the game sequences
        2. Calculate target values using rewards
        3. Train a network using backpropagation
